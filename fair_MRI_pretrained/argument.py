...
def get_args():
    ...
    parser.add_argument('--scheduler', default='MultiStepLR', type=str, required=False,
                        choices=['MultiStepLR', 'CosineAnnealingLR', 'ExponentialLR'])
    ...
    parser.add_argument('--network', default='mobilenetv2', type=str, choices=['mobilenetv2','shufflenetv2','resnet10','resnet18','resnet34','reset50'], help='network to train')
    parser.add_argument('--method', default='None', type=str, choices=['None','WCE','RW','oversampling','LBC'], help='fairness method')
    parser.add_argument('--augmentation', default=False, action='store_true')

    parser.add_argument('--lbc-eta', default=1, type=float)
    parser.add_argument('--lbc-iteration', default=10, type=int, help='training iteration for label bias correcting method')
    parser.add_argument('--lbc-reweighting-target-criterion', default='eopp', type=str, choices=['eo','eopp'])

    parser.add_argument('--pretrain_path', default='pretrain/resnet_10.pth', type=str, help='Path for pretrained model')
    parser.add_argument('--new-layer-names',default=['conv_seg'], type=list, help='New layer except for backbone')
